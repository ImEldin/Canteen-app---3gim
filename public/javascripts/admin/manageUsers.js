document.addEventListener('DOMContentLoaded', function () {
    ...
    function createCustomDropdown(selectId, optionsId, inputId, submitOnChange = false) {
    ...
    createCustomDropdown('pageSizeSelect', 'pageSizeOptions', 'pageSizeInput', true); // Submit form on change
});
